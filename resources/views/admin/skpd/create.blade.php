    ...
    <div class="col-md-8">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Form Tambah SKPD</h6>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.skpd.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('namaskpd') is-invalid @enderror" id="namaskpd" name="namaskpd" value="{{ old('namaskpd') }}" required autofocus>
                        @error('namaskpd')
