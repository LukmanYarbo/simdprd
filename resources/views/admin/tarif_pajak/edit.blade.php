...
<div class="container-fluid">
    ...
    <div class="card shadow-lg border-0 mb-4 mt-4">
        <div class="card-header py-3 bg-white border-bottom">
            <h6 class="m-0 fw-bold text-primary"><i class="bi bi-pencil-square me-2"></i>Form Edit Tarif Pajak PPh 21</h6>
        </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <select class="form-select @error('status') is-invalid @enderror" id="status" name="status" required>
                                <option value="T" {{ old('status', $tarifPajak->status) === 'T' ? 'selected' : '' }}>Tidak Aktif (T)</option>
                                <option value="Y" {{ old('status', $tarifPajak->status) === 'Y' ? 'selected' : '' }}>Aktif (Y)</option>
                            </select>
