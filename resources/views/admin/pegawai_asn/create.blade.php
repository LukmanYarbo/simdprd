...
<div class="container-fluid">
    ...
    <div class="card shadow-sm border-0">
        <div class="card-header py-3  border-bottom">
            <h6 class="m-0 font-weight-bold text-primary"><i class="bi bi-person-plus-fill me-2"></i>Form Tambah Pegawai</h6>
        </div>
        <div class="card-body p-4">
            <form action="{{ route('admin.pegawai-asn.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="d-flex justify-content-end gap-2 mt-4 pt-3 border-top">
                    <button type="reset" class="btn btn-outline-secondary px-4"><i class="bi bi-arrow-counterclockwise me-2"></i>Reset</button>
