...
<x-breadcrumbs :items="[
    ...
    ['label' => 'Edit Pegawai', 'icon' => 'ti ti-pencil']
]" />
@endsection
                                    ...
                                    <div class="form-floating">
                                        <select class="form-select @error('id_status_kawin') is-invalid @enderror" id="id_status_kawin" name="id_status_kawin" required>
                                            ...
                                            @foreach($statusKawin as $s)
                                                <option value="{{ $s->kode }}" {{ old('id_status_kawin', $pegawaiAsn->id_status_kawin) == $s->kode ? 'selected' : '' }}>{{ $s->nama }}</option>
                                            @endforeach
                                        </select>
                        ...
                        <div class="p-3 bg-body-tertiary rounded-3 h-100">
                            ...
                            <div class="form-floating mb-3">
                                <select class="form-select @error('id_ttd') is-invalid @enderror" id="id_ttd" name="id_ttd" required>
                                    <option value="T" {{ old('id_ttd', $pegawaiAsn->id_ttd) == 'T' ? 'selected' : '' }}>Tidak</option>
                                    <option value="Y" {{ old('id_ttd', $pegawaiAsn->id_ttd) == 'Y' ? 'selected' : '' }}>Ya</option>
                                </select>
