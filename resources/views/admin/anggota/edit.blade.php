...
<div class="container-fluid">
    ...
    <form id="wizardForm" class="wizard-modern" action="{{ route('admin.anggota.update', $anggota) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
                        ...
                        <div class="col-md-4 text-center">
                            ...
                            <div class="photo-uploader" id="photoUploader" title="Klik atau seret foto di sini">
                                @if($anggota->foto_anggota)
                                    <img id="preview" src="{{ asset('storage/' . $anggota->foto_anggota) }}" alt="Foto anggota">
                                @else
                                    <img id="preview" src="https://ui-avatars.com/api/?name={{ $anggota->nama_anggota }}&background=random&size=200" alt="Foto anggota">
                                @endif
                            ...
                            <input type="file" class="visually-hidden" id="foto_anggota" name="foto_anggota" accept=".jpg,.jpeg,.png">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <div class="wz-segmented mt-1">
                                        <input type="radio" class="btn-check" name="status_bpjs" id="status_bpjs_y" value="Y" {{ old('status_bpjs', $anggota->status_bpjs) == 'Y' ? 'checked' : '' }}>
                                        <label class="btn btn-outline-success" for="status_bpjs_y"><i class="ti ti-check me-1"></i> Ya</label>
                                        <input type="radio" class="btn-check" name="status_bpjs" id="status_bpjs_t" value="T" {{ old('status_bpjs', $anggota->status_bpjs) == 'T' ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="wz-segmented mt-1">
                                        <input type="radio" class="btn-check" name="status_jkk" id="status_jkk_y" value="Y" {{ old('status_jkk', $anggota->status_jkk) == 'Y' ? 'checked' : '' }}>
                                        <label class="btn btn-outline-success" for="status_jkk_y"><i class="ti ti-check me-1"></i> Ya</label>
                                        <input type="radio" class="btn-check" name="status_jkk" id="status_jkk_t" value="T" {{ old('status_jkk', $anggota->status_jkk) == 'T' ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="wz-segmented mt-1">
                                        <input type="radio" class="btn-check" name="status_jkm" id="status_jkm_y" value="Y" {{ old('status_jkm', $anggota->status_jkm) == 'Y' ? 'checked' : '' }}>
                                        <label class="btn btn-outline-success" for="status_jkm_y"><i class="ti ti-check me-1"></i> Ya</label>
                                        <input type="radio" class="btn-check" name="status_jkm" id="status_jkm_t" value="T" {{ old('status_jkm', $anggota->status_jkm) == 'T' ? 'checked' : '' }}>
