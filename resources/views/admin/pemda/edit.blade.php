...
@section('title', 'Edit Data Pemda')

@section('content')
<div class="container-fluid">
    <x-breadcrumbs title="Edit Data Pemda" :items="[
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Form Edit Data Pemda</h6>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.pemda.update', $pemda->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        @if($pemda->logo_pemda)
                            <div class="mt-2 text-muted fw-bold">Logo saat ini:</div>
                            <img src="{{ Storage::url($pemda->logo_pemda) }}" alt="Logo Pemda" class="img-thumbnail mt-1" style="max-height: 100px;">
                        @endif
                ...
                <div class="row mb-3">
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control @error('kota') is-invalid @enderror" id="kota" name="kota" value="{{ old('kota', $pemda->kota) }}" required>
                        @error('kota') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                    <div class="col-md-3">
                        <label for="kabupaten" class="form-label">Kabupaten</label>
                        <input type="text" class="form-control @error('kabupaten') is-invalid @enderror" id="kabupaten" name="kabupaten" value="{{ old('kabupaten', $pemda->kabupaten) }}" required>
                        @error('kabupaten') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                    <div class="col-md-3">
                        <label for="propinsi" class="form-label">Propinsi</label>
                        <input type="text" class="form-control @error('propinsi') is-invalid @enderror" id="propinsi" name="propinsi" value="{{ old('propinsi', $pemda->propinsi) }}" required>
                        @error('propinsi') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                    <div class="col-md-3">
                        <label for="kode_pos" class="form-label">Kode Pos</label>
                        <input type="text" class="form-control @error('kode_pos') is-invalid @enderror" id="kode_pos" name="kode_pos" value="{{ old('kode_pos', $pemda->kode_pos) }}" required>
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control @error('nama_bupati') is-invalid @enderror" id="nama_bupati" name="nama_bupati" value="{{ old('nama_bupati', $pemda->nama_bupati) }}" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control @error('jabatan_bupati') is-invalid @enderror" id="jabatan_bupati" name="jabatan_bupati" value="{{ old('jabatan_bupati', $pemda->jabatan_bupati) }}" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control @error('judul_bupati') is-invalid @enderror" id="judul_bupati" name="judul_bupati" value="{{ old('judul_bupati', $pemda->judul_bupati) }}" required>
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control @error('nama_wakil_bupati') is-invalid @enderror" id="nama_wakil_bupati" name="nama_wakil_bupati" value="{{ old('nama_wakil_bupati', $pemda->nama_wakil_bupati) }}" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control @error('jabatan_wakil_bupati') is-invalid @enderror" id="jabatan_wakil_bupati" name="jabatan_wakil_bupati" value="{{ old('jabatan_wakil_bupati', $pemda->jabatan_wakil_bupati) }}" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control @error('judul_wakil_bupati') is-invalid @enderror" id="judul_wakil_bupati" name="judul_wakil_bupati" value="{{ old('judul_wakil_bupati', $pemda->judul_wakil_bupati) }}" required>
...
<script>
    $(document).ready(function() {
        ...
        var initialId = $('#id_sekda').val();
        if(initialId) {
            fetchPegawaiDetails(initialId);
        }

        $('#id_sekda').on('change', function() {
            var id = $(this).val();
            fetchPegawaiDetails(id);
        });
    });
</script>
@endpush
