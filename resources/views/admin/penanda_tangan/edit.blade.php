                    ...
                    <form action="{{ route('admin.penanda-tangan.update', $penandaTangan->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="jenis_dokumen" id="jenis_dokumen"
                                ...
                                @foreach(['Surat Tugas', 'SPPD', 'Surat Keputusan'] as $jenis)
                                    <option value="{{ $jenis }}"
                                        {{ old('jenis_dokumen', $penandaTangan->jenis_dokumen) == $jenis ? 'selected' : '' }}>
                                        {{ $jenis }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-4">
                            ...
                            @error('id_skpd')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-text text-muted">Pilih SKPD untuk memuat daftar ASN.</div>
                        </div>
...
<script>
    $(document).ready(function () {
        ...
        // When SKPD changes, reset ASN selection
